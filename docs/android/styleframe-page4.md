---
title: "Styleframe - Page 4 (Minecraft-specialized)"
...
이 문서는 Minecraft 플레이에 특화된 Page 4의 스타일프레임을 정의합니다. **한 손가락 조작에 최적화**되어 좌측에 터치패드(시점 제어)와 DPad(이동)를 상하 배치하고, 우측에 전투/인벤토리/핫바 등 액션 버튼들을 배치합니다.
