...
> 전체 시스템 아키텍처는 [`technical-specification.md` §3]를, 용어 정의는 [`technical-specification.md` §6.2 Android 플랫폼 용어집]을 참조하세요.
...
**구현 요구사항**: `docs/Android/technical-specification-app.md` §2.2.2.1(KeyboardKeyButton 컴포넌트 설계 요구사항) 참조
...
**구현 요구사항**: `docs/Android/technical-specification-app.md` §2.2.2.2(ShortcutButton 컴포넌트 설계 요구사항) 참조

#### 2.3.3 매크로 버튼(MacroButton)

> **⚠️ 추후 개발 예정**: 본 컴포넌트는 향후 개발 계획에 포함되어 있으며, 현재는 구현되지 않았습니다.
...
**구현 요구사항**: `docs/Android/technical-specification-app.md` §2.2.2.3(MacroButton 컴포넌트 설계 요구사항) 참조
...
**구현 요구사항**: `docs/Android/technical-specification-app.md` §2.2.2.4(ContainerButton 컴포넌트 설계 요구사항) 참조
...
**참조**: `docs/design-guide-app.md` §2(색상 시스템), §5.2(상태 알림 토스트)

## 3. DPad

**강제 재연결 처리**: 기본 HID 키보드 기능(방향키)이므로 재연결 중에도 정상 동작, Disabled 상태로 전환하지 않음

**구현 요구사항**: `docs/Android/technical-specification-app.md` §2.2.2.5(DPad 컴포넌트 설계 요구사항) 참조
