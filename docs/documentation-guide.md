...
- `Android/styleframe-page2.md`: 절대좌표 패드 전용 페이지 (AbsolutePointingPad + 줌) UI 레이아웃과 스타일
- `Android/styleframe-page3.md`: 키보드 기능 중심 페이지의 UI 레이아웃과 스타일
- `Android/styleframe-page4.md`: Minecraft 게임에 특화된 페이지의 UI 레이아웃과 스타일
