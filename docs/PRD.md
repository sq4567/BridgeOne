...
참조: `docs/styleframe-essential.md`(Essential 모드 전용 페이지), `docs/styleframe-page4.md`(Minecraft 특화 페이지)
...
- 대표 액션: 조합 입력, 반복 입력
- 상세: `design-guide-app.md` §5, `styleframe-page3.md`

#### 3.2.4 절대좌표 패드 페이지
- 목적: 터치 위치가 곧 PC 커서 위치가 되는 절대좌표 포인팅 + 줌 기능
- 핵심 컴포넌트: AbsolutePointingPad (PointingArea + ControlBar + ZoomButton)
- 상세: `component-design-guide-app.md` §4, `styleframe-page2.md`

#### 3.2.5 게임 특화 페이지(Minecraft)
- 목적: 게임/작업 특화 매핑(DPad/시점/핫바 등)
- 핵심 컴포넌트: DPad, Camera Touch, Actions
- 상세: `design-guide-app.md` §1.2.1, `styleframe-page4.md`
