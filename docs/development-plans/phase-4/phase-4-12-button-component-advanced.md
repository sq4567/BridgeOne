---
title: "BridgeOne Phase 4.12: 버튼 컴포넌트 고급 기능"
description: "BridgeOne 프로젝트 Phase 4.12 - KeyboardKeyButton Sticky Hold, ContainerButton, Essential 모드 UI 재정비"
...
# BridgeOne Phase 4.12: 버튼 컴포넌트 고급 기능
...
**선행 조건**: Phase 4.10 (Page 4 키보드) 완료

**에뮬레이터 호환성**: ContainerButton 팝업 오버레이, Essential 모드 UI 재정비 전체 에뮬레이터에서 개발 가능.

---

## Phase 4.12.1: KeyboardKeyButton Sticky Hold
...
## Phase 4.12.2: ContainerButton 컴포넌트
...
## Phase 4.12.3: Essential 모드 UI 재정비
...
3. Boot Keyboard Cluster 재정비:
   - `FKeyPopupDialog` → Phase 4.12.2의 `ContainerButton`으로 교체
...
## Phase 4.12 완료 후 컴포넌트 기능 매트릭스

| 컴포넌트 | 기본 기능 | 고급 기능 | 구현 Phase |
|----------|----------|----------|-----------|
| KeyboardKeyButton | ✅ 탭 KeyDown/KeyUp | ⏳ Sticky Hold (4.9.1), Key Repeat (4.6.3) | 4.9.1 + 4.6.3 |
| ShortcutButton | ✅ 키 조합 순차 전송 | ✅ 디바운스, Alt+Tab 홀드 | 4.2.4 |
| ContainerButton | — | ✅ 일반/지속 팝업 모드 | 4.9.2 |
| MacroButton | — | ⏳ Phase 5+ (Disabled placeholder) | 4.2.5 (placeholder) |
| DPad | ✅ 4방향+대각선 탭 | ✅ Sticky Hold, 드래그 전환 | 4.8.1 + 4.8.2 |
