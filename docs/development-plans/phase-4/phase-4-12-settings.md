---
title: "BridgeOne Phase 4.12: 환경 설정"
description: "BridgeOne 프로젝트 Phase 4.12 - 앱 내 설정 UI 구현, 접근 편의 모드(Assisted Mode), DataStore 기반 설정 영속화"
...
## Phase 4.12.1: DataStore 인프라 및 SettingsRepository
...
**설정 항목 목록** (Phase 4.12.2에서 UI로 노출):
...
## Phase 4.12.3: 접근 편의 모드 (Assisted Mode)
