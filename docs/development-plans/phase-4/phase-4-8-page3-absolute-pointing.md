---
title: "BridgeOne Phase 4.8: Page 3 — 절대좌표 패드 페이지"
description: "BridgeOne 프로젝트 Phase 4.8 - Standard 모드 Page 3: AbsolutePointingPad, 줌 기능, Vendor CDC 줌 오버레이"
...
# BridgeOne Phase 4.8: Page 3 — 절대좌표 패드 페이지
...
**선행 조건**: Phase 4.7 (Page 2 풀 와이드 터치패드) 완료, Phase 4.3 (터치패드 고급 기능) 완료
...
## Phase 4.8.1: AbsolutePointingPad 기본 구현
...
8. ControlBar:
   ...
   - ZoomButton: 이 Phase에서는 Disabled 상태 (Phase 4.8.2에서 활성화)
...
## Phase 4.8.3: Vendor CDC 줌 상태 전송 및 PC 오버레이 연동
