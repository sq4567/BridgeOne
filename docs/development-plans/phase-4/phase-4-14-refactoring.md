---
title: "BridgeOne Phase 4.14: 리팩터링"
description: "BridgeOne 프로젝트 Phase 4.14 - 조정 가능 상수 중앙화 및 Deprecated API 교체"
...
| 하위 Phase | 내용 | 상태 |
|-----------|------|------|
| 4.14.1 | 조정 가능 상수 중앙화 | 미시작 |
| 4.14.2 | Deprecated API 교체 | 미시작 |

**선행 조건**: Phase 4.13 완료

---

## Phase 4.14.1: AppConstants.kt 신규 생성 및 상수 통합
...
## Phase 4.14.2: Deprecated API 교체
