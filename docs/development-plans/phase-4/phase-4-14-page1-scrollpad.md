---
title: "BridgeOne Phase 4.14: ScrollPad 컴포넌트 — 페이지 1 스크롤 전용 패드"
...
# BridgeOne Phase 4.14: ScrollPad 컴포넌트
...
- `styleframe-page1.md` §2.2-C 갱신 완료 (Phase 4.14 시작 전 기완료)
- `component-scrollpad.md` 신규 명세서 작성 완료 (Phase 4.14 시작 전 기완료)
...
**에뮬레이터 호환성**: 4.14.1~4.14.3 UI 개발은 에뮬레이터에서 가능. 실제 휠 이벤트 확인(4.14.2+) 및 관성 튜닝(4.14.4)은 실기기 필요.

| 하위 Phase | 내용 | 상태 |
|-----------|------|------|
| 4.14.1 | ScrollPad 골격 + MacrosPlaceholder 교체 | 미시작 |
| 4.14.2 | 수직 NORMAL 스크롤 구현 | 미시작 |
| 4.14.3 | 수평 축 추가 + 가이드라인 | 미시작 |
| 4.14.4 | INFINITE 관성 모드 + 모드 칩 | 미시작 |
| 4.14.5 | 레이아웃 비율 재조정 + 실기기 검증 | 미시작 |

---

## Phase 4.14.1: ScrollPad 골격 + MacrosPlaceholder 교체
...
## Phase 4.14.4: INFINITE 관성 모드 + 모드 칩
...
## Phase 4.14.5: 레이아웃 비율 재조정 + 실기기 검증
