...
- ESP32 연결 상태 기반 동적 화면 전환 (미연결 ↔ Standard)
...
**상태 기반 콘텐츠 전환**:
- **연결 대기**: 연결 프롬프트 카드 중심 콘텐츠 (ESP32 미연결)
- **연결 중**: 진행률 표시 중심의 콘텐츠
...
- **미연결 상태**: 연결 프롬프트 중심의 콘텐츠 (ESP32 CDC 미연결)
- **Standard 모드**: 대시보드 + 성능 지표 중심의 콘텐츠 (ESP32 핸드셰이크 완료)
