...
#### CP2102 USB-Serial 어댑터 (Silicon Labs)
- **공식 페이지**: [Silicon Labs CP2102](https://www.silabs.com/interface/usb-bridges/classic/device.cp2102)
- **주요 활용**: Android 앱에서 USB-Serial 통신, UART 프로토콜 구현
- **핵심 문서**: AN197 (Serial Communications Guide), AN809 (Android Platform Integration)
...
- **GitHub**: [Geekble-nano-ESP32S3](https://github.com/Geekble-nano-ESP32S3/)
- **주요 활용**: 하드웨어 핀 배치, CP2102 연결 방법, 전원 공급 설계
