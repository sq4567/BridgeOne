...
- **Essential/Standard**: 시스템 운용 상태. Essential는 Windows 서버와 연결되지 않은 상태, Standard은 서버와 연결되어 모든 확장 기능이 활성화된 상태
...
- **Keep-alive**: 연결 유지를 위한 주기적 신호 (0.5초 주기)
...
- **USB HID/CDC 통신**: ESP32-S3 동글을 통한 Android 앱과의 데이터 교환
...
#### 2.3.3 확장 경로: Vendor HID / CDC

**정의 및 특징**:
- **Vendor-Defined HID**: 제조사가 자유롭게 데이터 형식 정의 가능
...
**용어 정의**: 모든 문서에서 동일한 용어집 준수 [[memory:5809234]]
...
> **중요**: 모든 용어는 프로젝트 전체 용어집과 일관성을 유지하며, 특히 "활성/비활성" 대신 "Selected/Unselected", "Enabled/Disabled" 표현을 사용합니다 [[memory:5809234]].
